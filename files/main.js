...
(function($) {
	...
	$.NaxosTheme = {
		...
		share:function(network, title, image, url) {
			...
			//Share
			if (network==='twitter') {
				return window.open('https://web.archive.org/web/20250207212452/https://twitter.com/intent/tweet?text='+encodeURIComponent(title)+'&url='+encodeURIComponent(url), 'share', params);
			} else if (network==='facebook') {
				return window.open('https://web.archive.org/web/20250207212452/https://www.facebook.com/sharer/sharer.php?s=100&p[url]='+encodeURIComponent(url)+'&p[title]='+encodeURIComponent(title)+'&p[images][0]='+encodeURIComponent(image), 'share', params);
			} else if (network==='pinterest') {
				return window.open('https://web.archive.org/web/20250207212452/https://pinterest.com/pin/create/bookmarklet/?media='+image+'&description='+title+' '+encodeURIComponent(url), 'share', params);
			} else if (network==='linkedin') {
				return window.open('https://web.archive.org/web/20250207212452/https://www.linkedin.com/shareArticle?mini=true&url='+encodeURIComponent(url)+'&title='+title, 'share', params);
			}
...
/*
     FILE ARCHIVED ON 21:24:52 Feb 07, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:22:51 Nov 18, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 14.548
  LoadShardBlock: 152.493 (3)
  PetaboxLoader3.datanode: 146.258 (4)
  load_resource: 85.023
*/